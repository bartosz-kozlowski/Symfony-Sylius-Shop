...
//
// export function bootConfigurator () {
//
//   /* ---------- DOM ---------- */
...
//
//   if (!cartViewer || !cartList || !checkoutBtn) return   // nie jesteśmy na tej podstronie
//
//   /* ---------- 3-D globals ---------- */
...
//     const data = Array.from(cartModelMap.entries()).map(
//       ([productId, { variantCode, productName, modelPath }]) => ({
//         productId, variantCode, productName, modelPath
//       })
//     )
...
//
//   /* wczytaj koszyk natychmiast po utworzeniu viewer-a */
